...
<head>
    ...
    <title>Login Admin - FragrancesHub</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .btn-login:hover {
            box-shadow: 0 6px 20px rgba(11,61,46,.35);
    ...
    <div class="auth-card">
        <div class="auth-header">
            <div class="brand text-center">
                ...
                <div>Fragrances<span>Hub</span></div>
            </div>
        ...
        <div class="auth-body">
            ...
            <form method="POST" action="{{ route('admin.login') }}">
                ...
                <p class="text-center small text-muted mb-0">
                    <a href="{{ route('login') }}" class="link-green">Kembali ke Login User</a>
                </p>
            </form>
        </div>
    </div>
