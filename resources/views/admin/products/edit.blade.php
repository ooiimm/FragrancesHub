        ...
        <form action="{{ route('admin.products.update', $product->id) }}"
            ...
            <div class="card card-admin mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6><i class="bi bi-collection me-2"></i>Varian Produk (Ukuran)</h6>
                    <a href="{{ route('admin.products.variants.create', $product->id) }}" class="btn btn-sm btn-primary-custom">
                ...
                <div class="card-body p-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="fw-600">{{ $variant->size }}</td>
                                        <td style="color:var(--green-mid);font-weight:600;">
                                            Rp {{ number_format($variant->price, 0, ',', '.') }}
                                        </td>
                                        <td>
                                            <span class="badge" style="background:{{ $variant->stock > 0 ? '#d1fae5' : '#fee2e2' }};color:{{ $variant->stock > 0 ? '#065f46' : '#991b1b' }};">
                                                {{ $variant->stock }} pcs
                                            </span>
                                        </td>
                                        <td>
                    ...
                    @else
                        <div class="text-center py-5" style="color:#9ca3af;">
                            <i class="bi bi-inbox" style="font-size:2.5rem;opacity:.5;"></i>
                            <p class="mt-2 mb-0">Belum ada varian produk</p>
                            <small>Tambahkan varian seperti 50ml, 100ml, dll dengan harga berbeda</small>
                        </div>
                    @endif
                </div>
            </div>
