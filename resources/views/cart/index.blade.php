        ...
        <div class="col-lg-8">
            <div class="bg-white rounded-4 shadow-sm overflow-hidden">
                ...
                @php
                    ...
                    $itemStock = $item->product_variant_id ? $item->variant->stock : $item->product->stock;
                    $itemName = $item->variant_size
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            @if($item->variant_size)
                                <div class="small mb-1" style="color:var(--green-mid);font-weight:600;">
                        ...
                        <div class="d-flex flex-column align-items-end gap-2">
                            ...
                            <form action="{{ route('cart.update', $item->id) }}"
                                ...
                                <button type="button"
                                        ...
                                        onclick="changeQty({{ $item->id }}, -1, {{ $itemStock }})">
                            ...
                            <form action="{{ route('cart.remove', $item->id) }}" method="POST">
                                ...
                                <button type="submit"
                                        ...
                                        onclick="return confirm('Hapus \'{{ addslashes($itemName) }}\' dari keranjang?')">
